...
//     cy.visit('/')
//     cy.get('[data-test-id="new-comment-editor"]').should('not.exist')
//
...
//     cy.visit('/')
//     cy.get('[data-test-id="new-comment-submit"]').should('not.exist')
//     // Get the editor to show
//     cy.get('[data-test-id="new-comment-button"]').click()
...
//     cy.get('[data-test-id="new-comment-submit"]').should('not.have.class', 'submitting')
//   })
// })
